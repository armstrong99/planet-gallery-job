...
const Team: React.FC<TeamProps> = ({title, name, imgUrl, socialMedia, index}) => {
     return (  
         <>
         <section className={`flex flex-col items-center md:w-1/3 md:h-auto ${index! > 0 ? 'my-20' : 'my-10'}`}>
         ...
         <figure>
             ...
             <figcaption className={`teamName my-3`}>{name}</figcaption>
         </figure>

         <p className={'teamPosition'}>{title}</p>
